...
export class UsersMap {
  ...
  constructor(private _usersMapService: UsersMapService, private _baConfig: BaThemeConfigProvider,
   ...
   private _CommonDataService: CommonDataService) {
     ...
     this.mapData = {
      ...
      dataProvider: {
        ...
        areas: [
          { title: 'Al-Basrah', id: 'IQ-BA', color: '#66ffb3', customData: '965', groupId: '1', custtitle: 'Basra' },
          { title: 'Al-Qadisiyah', id: 'IQ-QA', color: '#66ff8c', customData: '685', groupId: '2', custtitle: 'Qadisiyah (Diwaniyah)' },
          { title: 'Al-Muthannia', id: 'IQ-MU', color: '#66ffff', customData: '854', groupId: '3', custtitle: 'Muthanna' },
          { title: 'An-Najaf', id: 'IQ-NA', color: '#66b3ff', customData: '754', groupId: '4', custtitle: 'Najaf' },
          { title: 'Babylon', id: 'IQ-BB', color: '#0066cc', customData: '867', groupId: '5', custtitle: 'Babylon' },
          { title: 'Baghdad', id: 'IQ-BG', color: '#0bb238', customData: '759', groupId: '6', custtitle: 'Baghdad' },
          { title: 'Diyala', id: 'IQ-DI', color: '#ffb84d', customData: '302', groupId: '7', custtitle: 'Diyala' },
          { title: 'Dhi-Qar', id: 'IQ-DQ', color: '#ffdaa1', customData: '102', groupId: '8', custtitle: 'Dhi Qar (Nasiriyah)' },
          { title: 'Sala ad-Din', id: 'IQ-SD', color: '#ffd736', customData: '23', groupId: '9', custtitle: 'Salahaddin' },
          { title: 'Karbala', id: 'IQ-KA', color: '#5eccc0', customData: '96', groupId: '10', custtitle: 'Karbala' },
          { title: 'Kirkuk', id: 'IQ-KI', color: '#ffff77', customData: '80', groupId: '11', custtitle: 'Kirkuk' },
          { title: 'Maysan', id: 'IQ-MA', color: '#997463', customData: '100', groupId: '12', custtitle: 'Maysan' },
          { title: 'Ninawa', id: 'IQ-NI', color: '#55cc20', customData: '20', groupId: '13', custtitle: 'Ninewa (Mosul)' },
          { title: 'Wasit', id: 'IQ-WA', color: '#cc5520', customData: '100', groupId: '14', custtitle: 'Wasit' },
        ],
      },
      areasSettings: {
        autoZoom: false,
